...
#rangos_constantes = [[0.001,0.03,2],[0.002,0.08,1],[0.002,0.01,2]]
constantes = Combinaciones(rangos_constantes)
        
Ubicacion_caso = 'Casos/Biaxial_Yeoh/'
Nombre_salida = 'Biaxial_YeohTe'
