...
def Demiray():
    ...
    desplazamientos, tensiones, gradientes, malla = Vulcan().Biaxial_Demiray_20(a,b)
    grad = gradientes[0]
...
def Yeoh():
    ...
    desplazamientos, tensiones, gradientes, malla = Vulcan().Biaxial_Yeoh_20(a,b,c)
    grad = gradientes[0]
...
if __name__ == '__main__':
    ...
    if modelo == 'Demiray':
        ...
        for i in range(numero_simulaciones):
            print(f'####################################### Simulacion {i+1}/{numero_simulaciones} #######################################')
            numero_guardado = i
            desplazamientos, tensiones, gradientes, malla = Yeoh()
            nombre_T = 'Tensiones' + Nombre_info_salida + str(numero_guardado) + '.npz' 
            nombre_D = 'Desplazamientos' + Nombre_info_salida  + str(numero_guardado) + '.npz'
            nombre_G = 'Gradientes' + Nombre_info_salida  + str(numero_guardado) + '.npz'
