...
#rangos_constantes = [[0.1,0.9,2],[0,0,1],[3,14,2]]

constantes = Combinaciones(rangos_constantes)
#print(constantes)

Ubicacion_caso = 'Casos/Biaxial_Mooney/'
Nombre_salida = 'Biaxial_MooTe'
Nombre_info_salida = '_MOON_Biaxial_'  ## Nombre caso EJ: _Tracion_Demiray_
Ubicacion_salida = 'Resultados/Biaxial_Mooney/'
