...
class Vulcan():
    ...
    def Biaxial_Demiray(self,a,b,penal = 1000,verbose = True):
    ...
    def Biaxial_Yeoh(self,a,b,c,penal = 1000,verbose = True):
        print('####### Modelo Yeoh #######')
    ...
    def Biaxial_Mooney(self,a,b,c,penal = 10,verbose = True):
